...
def handle_message(chat_id: int, text: str) -> None:
    ...
    if text.startswith("/start") or text.startswith("/help"):
        send_message(
            ...
            "<i>Bạn cứ nhắn tự nhiên. Bot sẽ đọc ý và thao tác với WooCommerce.</i>\n\n"
            "<b>1. Đơn hàng & doanh thu</b>\n"
            "• <i>Hôm nay có đơn hàng không?</i>\n"
            "• <i>Doanh thu tháng 5 2026 là bao nhiêu?</i>\n"
            "• <i>Chi tiết đơn hàng 2365</i>\n"
            "• <i>Chi tiết đơn hàng hôm nay</i> - xuất Excel\n"
            "• <i>Chi tiết đơn hàng tháng 5 năm 2026</i> - xuất Excel\n"
            "• <i>Xuất chi tiết đơn hàng từ ngày 04/05/2026 đến ngày 08/05/2026</i> - xuất Excel\n\n"
            "<b>2. Sản phẩm & tồn kho</b>\n"
            "• <i>Có bao nhiêu sản phẩm đang bán?</i>\n"
            "• <i>Có bao nhiêu sản phẩm còn hàng?</i>\n"
            "• <i>Xuất tất cả sản phẩm trên web</i> - gửi Excel\n"
            ...
            "• <i>Tên sản phẩm cho có hàng</i> / <i>hết hàng</i>\n\n"
