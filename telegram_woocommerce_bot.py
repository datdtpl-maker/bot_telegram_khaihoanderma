...
def handle_message(chat_id: int, text: str) -> None:
    ...
    if text.startswith("/start") or text.startswith("/help"):
        send_message(
            ...
            "<b>3. Đồng bộ & đăng sản phẩm từ Notion</b>\n"
            "• <b>Quy trình đăng sản phẩm mới:</b>\n"
            "  1. Tạo dòng sản phẩm trên Notion. Điền Tên sản phẩm, Từ khóa SEO Rank Math, và URL Google Drive chứa ảnh ở cột Media sản phẩm (phải share quyền xem công khai).\n"
            "  2. Chọn liên kết ở cột <b>Bài content Tây</b> đến trang con chứa nội dung bài viết.\n"
            "  3. Trong trang Bài content Tây, dòng đầu tiên phải ghi rõ: "
            "<code>Danh mục sản phẩm: [Tên danh mục] - Giá: [Giá thường] - Giá khuyến mãi: [Giá khuyến mãi nếu có]</code>\n"
            "  4. Chuyển Trạng thái (Status) của hàng sang <b>`Báo IT đăng`</b>.\n"
            "  5. Nhắn tin lệnh: <code>đồng bộ notion</code> cho bot.\n"
            "• <b>Kết quả tự động:</b> Bot tải ảnh từ Drive, tạo sản phẩm WooCommerce, lưu cấu hình SEO Rank Math (tối đa 4 từ khóa đầu), sau đó tự chuyển trạng thái Notion sang <code>Đã đăng web</code>, tích chọn <code>IT đã đăng</code> và cập nhật <code>Link web</code>.\n\n"
            "<b>4. Xóa sản phẩm</b>\n"
            "• <i>Xóa sản phẩm [Tên sản phẩm]</i>\n\n"
            "<b>5. Site Kit / Google (Báo cáo SEO)</b>\n"
            ...
            "<b>6. Lệnh hệ thống & Kiểm tra</b>\n"
            "• <code>ping</code> - kiểm tra bot còn chạy.\n"
            "• <code>/whoami</code> - xem Chat ID của bạn.\n"
            "• <code>đồng bộ sản phẩm</code> - tải lại danh sách sản phẩm mới nhất từ website WooCommerce vào bộ nhớ đệm của bot.\n"
            "• <code>đồng bộ notion</code> - quét và đăng toàn bộ sản phẩm đang chờ duyệt ở Notion lên WooCommerce.\n\n"
            "<b>Xác nhận thao tác:</b>\n"
            "Các thao tác sửa giá, tồn kho hoặc xóa sản phẩm trực tiếp từ bot đều cần nhắn <b>xác nhận</b>. "
